...
<body>
    <div class="container">
        <h1 class="mt-5">Loan Application Form</h1>
        <form id="loanApplicationForm" class="row mt-3" method="post" action="http://192.168.0.231/loancrm/api/cutomer-data-wp-bl-post">
            <!-- Your desired loan amount field -->
            <!-- <div class="form-group col-sm-4">
                <label>Your desired loan amount</label>
                <div class="input-group">
                    <span class="input-group-addon">Rs</span>
                    <input type="text" placeholder="XXXXXXXXX" class="form-control amount required" name="loan_amount" data-validation="required number" data-validation-error-msg="Please enter a valid loan amount" id="loan_amount" tabindex="1" value="" autocomplete="Off" oninput="formatAmount(this)">
                </div>
            </div> -->
            <div class="form-row">
            <div class="col-md-4 form-group">
                ...
                <input type="tel" placeholder="Enter Number" class="form-control mobile required error" data-validation="required length custom" data-validation-length="10" data-validation-regexp="^\d{10}$" data-validation-error-msg="Please enter a valid 10-digit phone number" maxlength="10" name="mobile_number" id="mobile_number" tabindex="3" autocomplete="Off" oninput="formatPhoneNumber(this)">
                
                <span class="phone_number_error_indicator help-block form-error">Please enter a valid 10-digit phone number</span>
            </div>
            <div class="col-md-4 form-group">
                <label>Your desired loan amount</label>
                <div class="input-group">
            ...
            <div class="form-row">
                <div class="col-md-4 form-group">
                    ...
                    <input type="number" name="pincode" id="pincode" class="form-control" placeholder="Pincode" onchange="getCityStateFromPincode(this.value)" required>
                </div>
                <div class="col-md-4 form-group">
            ...
            <div class="form-group col-sm-4">
                ...
                <select title="Select your employment" class="form-control wsselectpicker required employment select2-hidden-accessible" id="employment_type_id" name="employment_type_id" data-validation="required" data-validation-error-msg="Please select current employment type" tabindex="4" autocomplete="Off" onchange="toggleEmploymentFields()">
                    <option>Select--</option>
                    <option value="3">Self Employed Business</option>
                    <option value="2">Self Employed Professional</option>
                </select>
                <span class="employment_error_indicator help-block form-error">Please select current employment type</span>
            </div>

            <!-- Fields for Self Employed Business -->
            <div class="form-group col-sm-4" id="selfEmployedBusinessFields" style="display: ;">
                <label>Business Name</label>
                <input type="text" class="form-control" name="business_name" tabindex="5" autocomplete="Off" placeholder="Business Name">
            </div>

            <!-- Fields for Self Employed Professional -->
            <div class="form-group col-sm-4" id="selfEmployedProfessionalFields" style="display: ;">
                <label>Profession</label>
                <input type="text" class="form-control" name="profession" tabindex="6" autocomplete="Off" placeholder="Enter Profession">
            </div>
            ...
            <div class="form-group col-sm-4 has-error" id="annual-turnover" style="display: block;">
                <label>
                    ...
                    <a href="javascript:void(0)" data-toggle="tooltip" name="annual_turnover" data-placement="top" title="" data-original-title="Your last financial year turnover, as filed with ITR" class="">
                        <span class="badge badge-warning">?</span>
                    </a>
                </label>
                <div class="input-group">
                    <span class="input-group-addon">Rs</span>
                    <select title="Select Turnover" class="form-control wsselectpicker required select2-hidden-accessible" name="annual_turnover" id="annual_turnover" data-validation="required" data-validation-error-msg="Please enter the annual turnover" tabindex="7" autocomplete="Off" aria-hidden="true" onchange="toggleBasicInformationFields()">
                ...
                <span class="annual_turnover_error_indicator help-block form-error">Please enter the annual turnover</span>
            </div>
            ...
            <div class="form-group col-sm-4" id="years-in-business" style="display: ;">
                ...
                <input type="number" class="form-control" name="years_in_business" tabindex="9" autocomplete="Off" placeholder="Years In Current Business">
            </div>
            ...
            <div id="contract-view">
                ...
                By submitting this form, you have read and agree to the<a href="" target="_blank" class="clr-blue4 TdecorN"> </a>,<a href="" target="_blank" class="clr-blue4 TdecorN"> Terms of Use </a> &amp; <a href="" target="_blank" class="clr-blue4 TdecorN">Privacy Policy </a></div>
...
function handle_loan_application_form_submission() {
    if (isset($_POST['loan_application_form_submit'])) {
     ...
     add_action('init', 'handle_loan_application_form_submission');
