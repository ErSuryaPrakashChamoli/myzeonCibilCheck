                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="my-input" class="form-control" type="text" name=""
                                        placeholder="enter age" wire:model="pancard">
                                    <span class="text-danger">
                                        @error('pancard')
                                            {{ $message }}
                                        @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                        ...
                                        placeholder="Date of Birth" wire:model ="dateofbirth" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="my-input" class="form-control" type="text" name=""
                                        placeholder="enter age" wire:model="email">
                                    <span class="text-danger">
                                        @error('email')
                                            {{ $message }}
                                        @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="my-input" class="form-control" type="text" name=""
                                        placeholder="enter age" wire:model="mobileNumber">
                                    <span class="text-danger">
                                        @error('mobileNumber')
                                            {{ $message }}
                                        @enderror
